...
\begin{tikzpicture}
\node(A) at (0,4) {\txt{History\\\includegraphics[width=2cm]{history_1.png}\\len=2}};
\node(B) at (-4,0) {\txt{\includegraphics[width=3cm]{FRA_region_1.png}\\Focal Schemata}};
\node(C1) at (-4.5, 1.65) {};
...
\node(S) at (-3.5, -5) {\includegraphics[width=3cm]{logistic.png}};
